...
| primitives/Table                  | tr                                           | packages/design-system/src/primitives/Table/index.tsx:237                | hover:bg-surface-sunken → RowLinkHover                                                                            | unresolved: className not fully resolved → none                                                                                                                                                                                                                                                                                                         | active:bg-surface-sunken active:border-l-border-strong → RowLinkActive                                                                         |
