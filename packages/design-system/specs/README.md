...
| primitives/Menu                   | button                                       | packages/design-system/src/primitives/Menu/index.tsx:144                 | hover:bg-surface-sunken → none                                                                                                             | focus-visible:outline-2 focus-visible:outline-offset-ring focus-visible:outline-focus-ring → EscapeReturnsFocusToTrigger                                                                                                                                                                                                                                | active:bg-background active:ring-2 active:ring-border-strong → none                                                       |
...
| selection | 7 real call sites | Menu:Hover | Menu:FocusVisible; Menu:KeyboardNavigation; Menu:EscapeReturnsFocusToTrigger | Menu:Active    | Menu:LoadingItem             |
