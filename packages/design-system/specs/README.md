...
| primitives/Button                 | button                                       | packages/design-system/src/primitives/Button/index.tsx:207               | hover:bg-surface-sunken → Hover                                                                                   | focus-visible:outline-2 focus-visible:outline-offset-ring focus-visible:outline-focus-ring → FocusVisible; SecondaryFocusVisible; GhostFocusVisible; DestructiveFocusVisible                                                                                                                                                                            | active:bg-background active:ring-2 active:ring-border-strong → Active; SecondaryActive; DestructiveActive; GhostActive                         |
