...
_This is the feature's only deprecation, and it predates `GOVERNANCE.md`: T557 (PR #68) landed six
days before T573 wrote this procedure down (T573, PR #69), which is why
