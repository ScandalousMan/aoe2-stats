...
// `mobile1` preset (see `MatchRow.stories.tsx`'s identical rationale for why a preset name, why
// `mobile1`, and why the pin has no visible effect in this Storybook build today) — `Board` above
