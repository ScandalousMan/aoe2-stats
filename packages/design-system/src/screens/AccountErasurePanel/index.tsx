      ...
      <p className="mt-6 font-sans text-md">
        <a
          ...
          className={cx(
            ...
            // T591: this copy was missing the underline-thickness half of `Link`'s own `inline`
            // recipe (`decoration-1 underline-offset-2 hover:decoration-2 active:decoration-2`,
            // `primitives/Link/index.tsx`'s `underline` constant) — hover and active still shared
            // the underline's own weight, one of the two signals `structural-tier.md` §9 "hover"
            // ("two signals, one of which is not colour") documents for every link in this
            // product. Found and fixed alongside the identical omission in `PrivacyNotice` and
            // `ThirdPartyObjectionForm` (T591's own instruction: all three or none).
