...
value: phase 1's 1280-wide light captures must come back **pixel-identical** to the 279 baselines
that exist today, which is the only proof available that the harness change is correct, and it is
available only before anything else moves.
